...
def download_and_extract_ui_files(version: str):
    ...
    base_url = urllib.parse.urljoin(
        "https://github.com/livepeer/comfystream/releases/download/",
        f"v{version}/comfystream-uikit.zip",
    )
    fallback_url = (
        "https://github.com/livepeer/comfystream/releases/latest/download/comfystream-uikit.zip"
    )
